 ...
 */
Imgur.prototype.search = function (query, sort, page, imgurOptions) {
    ...
    var options = {
        ...
        sort + '/' + page + '/?q=' + encodeURIComponent(query),
        headers: {
            'Authorization': 'Client-ID ' + this.apiKey
        }
    };

    if (imgurOptions && 'size' in imgurOptions) {
        options.uri += '&q_size_px=' + imgurOptions.size;
    }

    if (imgurOptions && 'type' in imgurOptions) {
        options.uri += '&q_type=' + imgurOptions.type;
    }
